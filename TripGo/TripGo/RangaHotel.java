...
public class RangaHotel extends JFrame {
    ...
    RangaHotel() {
		...
		*/
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Comparative Hotel !");
        label1.setBounds(580, 12, 600, 50);
        label1.setFont(f2);
        c.add(label1);
        ...
        // Pack 1 Details
        pack1 = new JRadioButton("Relax Point");
        pack1.setBounds(430, 120, 120, 30);
        pack1.setFont(f4);
        ...
        // Pack 2 Details
        pack2 = new JRadioButton("Tiger In");
        pack2.setBounds(610, 120, 120, 30);
        pack2.setFont(f4);
        ...
        label3.setBounds(610, 150, 520, 50);
        label3.setFont(f4);
        c.add(label3);
        ...
        // Pack 3 Details
        pack3 = new JRadioButton("Cassetl HTL");
        pack3.setBounds(790, 120, 120, 30);
        pack3.setFont(f4);
		...
		*/
        ...
        public void actionPerformed(ActionEvent ae) {
		        ...
		        // Logo
        logo = new ImageIcon(getClass().getResource("/images/htl.png"));
        imgLabel = new JLabel(logo);
    ...
    public static void main(String[] args) {
        ...
        RangaHotel frame = new RangaHotel();
        frame.setVisible(true);
    }
}
