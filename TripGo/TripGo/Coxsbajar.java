...
public class Coxsbajar extends JFrame {

    private Container c;
    private ImageIcon icon, logo, coxsbajar,b2;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/coxs.png"));
