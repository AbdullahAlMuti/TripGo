...
public class Registration extends JFrame {
    ...
    Registration() {
		...
		*/
        ...
        label1.setBounds(430, 65, 500, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        label1.setBounds(430, 100, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(570, 110, 260, 30);
        tf1.setFont(f5);
        c.add(tf1);
        ...
        label1.setBounds(430, 135, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JTextField();
        tf2.setBounds(570, 145, 260, 30);
        tf2.setFont(f5);
        c.add(tf2);
        ...
        label1.setBounds(430, 170, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf3 = new JPasswordField();
        tf3.setBounds(570, 180, 260, 30);
        tf3.setFont(f2);
        tf3.setEchoChar('*');
        c.add(tf3);
        ...
        securityQsn.setBounds(570, 215, 259, 30);
        ...
        label1.setBounds(430, 240, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf4 = new JTextField();
        tf4.setBounds(570, 250, 260, 30);
        tf4.setFont(f5);
        c.add(tf4);
        ...
        label1.setBounds(430, 275, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf5 = new JTextField();
        tf5.setBounds(615, 285, 215, 30);
        tf5.setFont(f5);
        c.add(tf5);
        ...
        label1 = new JLabel();
        label1.setText(" " + a + " + " + b + " ");
        label1.setBounds(530, 285, 75, 30);
        label1.setFont(f4);
		...
		*/
        ...
        btn4.addActionListener(new ActionListener() {
		   ...
		   // Logo
        logo = new ImageIcon(getClass().getResource("/images/registration.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(0, 0, logo.getIconWidth(), logo.getIconHeight());
        c.add(imgLabel);
