...
public class Rangamati extends JFrame {

    private Container c;
    private ImageIcon icon, logo, rangamati;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/Rangamati.png"));
