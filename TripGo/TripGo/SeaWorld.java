...
public class SeaWorld extends JFrame {

    private Container c;
    private ImageIcon icon, logo, seaWorld;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/SeaWorld.png"));
