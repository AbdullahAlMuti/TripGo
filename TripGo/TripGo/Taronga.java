...
public class Taronga extends JFrame {

    private Container c;
    private ImageIcon icon, logo, taronga;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/taronga.png"));
