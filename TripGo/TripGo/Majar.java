...
public class Majar extends JFrame {

    private Container c;
    private ImageIcon icon, logo, majar;
...
*/
        ...
        public void actionPerformed(ActionEvent ae) {
                ...
                setVisible(false);
                Sylhet frame = new Sylhet();
                frame.setVisible(true);
            }
        });
		
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/majar.png"));
