...
public class Sajek extends JFrame {

    private Container c;
    private ImageIcon icon, logo, sajek;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/sajek.png"));
