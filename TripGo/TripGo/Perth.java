...
public class Perth extends JFrame {

    private Container c;
    private ImageIcon icon, logo, perth;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/perth.png"));
