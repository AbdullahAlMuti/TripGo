...
public class Hobart extends JFrame {

    private Container c;
    private ImageIcon icon, logo, hobart;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/hobart.png"));
