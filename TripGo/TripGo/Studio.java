...
public class Studio extends JFrame {
    ...
    private Container c;
    private ImageIcon icon, logo, studio;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/Studio.png"));
