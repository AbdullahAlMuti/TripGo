...
public class Singapur extends JFrame {

    private Container c;
    private ImageIcon icon, logo, singapur;
...
*/
        ...
        // JButtons
        btn1 = new JButton("MARINA");
        btn1.setBounds(150, 450, 200, 50);
        btn1.setFont(f1);
        ...
        btn2 = new JButton("Universal Studio");
        btn2.setBounds(380, 450, 200, 50);
        btn2.setFont(f1);
        ...
        btn3 = new JButton("Garden Boy");
        btn3.setBounds(610, 450, 200, 50);
        btn3.setFont(f1);
		...
		btn4 = new JButton("PAPUA");
        btn4.setBounds(845, 450, 150, 50);
        btn4.setFont(f1);
   ...
   // Exit Button
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/Singapur.png"));
