...
public class Darling extends JFrame {

    private Container c;
    private ImageIcon icon, logo, darling;
...
*/
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/darling.png"));
